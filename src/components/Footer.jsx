...
function Footer(){
    ...
    return(
        <>
        <footer className="bg-gradient-to-b from-white via-[#d3e7f4] to-[#f5d9f8]">
            <div className="max-w-screen-xl px-4 py-20 mx-auto sm:px-6 lg:px-8 mt-10">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                <img
                src={EsthaLogo}
                alt="Estha Logo"
                className="w-25 -mb-10 -ml-20 -mt-20 shadow-none"
                />
